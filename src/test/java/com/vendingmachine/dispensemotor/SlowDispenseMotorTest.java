...
public class SlowDispenseMotorTest {
    private SlowDispenseMotor slowDispenseMotor;

    @Before
    public void setUp() throws Exception {
        slowDispenseMotor = new SlowDispenseMotor();
    }
    ...
    public void dispenseProduct() throws Exception {
        ...
        slowDispenseMotor.dispenseSelectedProduct(inventory.get("A1"), "A1");
